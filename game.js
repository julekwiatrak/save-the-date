...
const translations = {
  en: {
    ...
    failText: "The date met the floor. A tragic but extremely preventable outcome.",
  },
  pl: {
    play: "GRAJ",
    ...
    failText: "Daktyl spotkał się z podłogą. Tragedia, której naprawdę dało się zapobiec.",
  },
  zh: {
    play: "開始遊戲",
    again: "再玩一次",
